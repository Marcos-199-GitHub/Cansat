...
def compress_img(image_name, new_size_ratio=0.9, quality=90, width=None, height=None, to_jpg=True,lowBits = 0,Gray=False):
...
if __name__ == "__main__":
    ...
    parser.add_argument("-b8", "--lowbit", action="store_true", help="Convert to 8 bit resolution")
    ...
    print("="*50)
    # compress the image
    compress_img(args.image, args.resize_ratio, args.quality, args.width, args.height, args.to_jpg,args.lowbit,args.grayscale)
