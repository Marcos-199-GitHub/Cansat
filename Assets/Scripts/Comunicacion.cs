...
public class Comunicacion : MonoBehaviour{
    ...
    private void Update(){
        if( serialPort.IsOpen ){
            ...
            if( DatosRecibidos.tamañoImagen == 0 && serialData.Contains( "{" ) && serialData.Contains( "}" ) ){//Si el mensaje son los datos
            ...
            else if( DatosRecibidos.tamañoImagen > 0 ){
                Debug.Log( $"imagen de {DatosRecibidos.tamañoImagen} bytes" );
